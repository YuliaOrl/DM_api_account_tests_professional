...
class LoginApi:
    ...
    async def v1_account_login_all_delete(
        ...
        with allure.step("DELETE /v1/account/login/all"):
    ...
    async def v1_account_login_all_delete_with_http_info(
        ...
        with allure.step("DELETE /v1/account/login/all (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def v1_account_login_all_delete_without_preload_content(
        ...
        with allure.step("DELETE /v1/account/login/all (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
    ...
    async def v1_account_login_delete(
        ...
        with allure.step("DELETE /v1/account/login"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def v1_account_login_delete_with_http_info(
        ...
        with allure.step("DELETE /v1/account/login (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def v1_account_login_delete_without_preload_content(
        ...
        with allure.step("DELETE /v1/account/login (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
    ...
    async def v1_account_login_post(
        ...
        with allure.step("POST /v1/account/login"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def v1_account_login_post_with_http_info(
        ...
        with allure.step("POST /v1/account/login (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def v1_account_login_post_without_preload_content(
        ...
        with allure.step("POST /v1/account/login (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
