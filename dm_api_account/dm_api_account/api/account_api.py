...
class AccountApi:
    ...
    async def activate_with_http_info(
        ...
        with allure.step("PUT /v1/account/{token} (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def activate_without_preload_content(
        ...
        with allure.step("PUT /v1/account/{token} (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
    ...
    async def change_email_with_http_info(
        ...
        with allure.step("PUT /v1/account/email (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def change_email_without_preload_content(
        ...
        with allure.step("PUT /v1/account/email (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
    ...
    async def change_password_with_http_info(
        ...
        with allure.step("PUT /v1/account/password (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def change_password_without_preload_content(
        ...
        with allure.step("PUT /v1/account/password (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
    ...
    async def get_current_with_http_info(
        ...
        with allure.step("GET /v1/account (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def get_current_without_preload_content(
        ...
        with allure.step("GET /v1/account (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
    ...
    async def register_with_http_info(
        ...
        with allure.step("POST /v1/account (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def register_without_preload_content(
        ...
        with allure.step("POST /v1/account (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
    ...
    async def reset_password_with_http_info(
        ...
        with allure.step("POST /v1/account/password (with HTTP info)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            await response_data.read()
            return self.api_client.response_deserialize(
                response_data=response_data,
    ...
    async def reset_password_without_preload_content(
        ...
        with allure.step("POST /v1/account/password (raw response)"):
            response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
            return response_data.response
